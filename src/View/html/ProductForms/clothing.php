                      ...
                      <!-- <fieldset class="col-mb-3">
                        <legend>Gender</legend>
                          <div class="form-check">
                            <input type="radio" name="gender" value="male" class="form-check-input" id="exampleRadio1" <?=isset($values?->gender) || $values?->gender == "female" ? 'checked' : false ?>>
                              <label class="form-check-label" for="exampleRadio1">Male</label>
                          </div>
                          <div class="mb-3 form-check">
                            <input type="radio" name="gender" value="female" class="form-check-input" id="exampleRadio2" <?=isset($values?->gender) || $values?->gender == "female" ? 'checked' : false ?>>
                            <label class="form-check-label" for="exampleRadio2">Female</label>
                          </div>
                          <div class="mb-3 form-check">
                            <input type="radio" name="gender" value="unisex" class="form-check-input" id="exampleRadio2" <?=isset($values?->gender) || $values?->gender == "female" ? 'checked' : false ?>>
