...
class ShopController
{
    ...
    static function get_shop(Request $req, Response $res)
    {
        try{
            ...
            return ResponseHandler::sendSuccessResponse($res, $shop->toArray(), ["cache_data" => $req->path()]);
        }catch(\Exception $e){
    ...
    static function get_owner(Request $req, Response $res)
    {
        try{
            $shop = Shop::find($req->params('id'));
            if(!$shop) throw new ShopException("Shop not found", 404);
